                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        ...
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            ...
                            <a href="{{ route('products.create') }}"><button class="btn btn-info"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ asset('image/mas/img/' . $item->image1) }}"
                                                            alt="{{ $item->name }}" width="50" height="50"
                                                            style="margin-right:10px;">
                                                    </div>
                                                    <div>
                                                        <img src="{{ asset('image/mas/img/' . $item->image2) }}"
                                                            alt="{{ $item->name }}" width="50" height="50"
                                                            style="margin-right:10px;">
                                                    </div>
                                                    <div>
                                                        <img src="{{ asset('image/mas/img/' . $item->image3) }}"
                                                            alt="{{ $item->name }}" width="50" height="50"
                                                            style="margin-right:10px;">
                                                    </div>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <span
                                                    class="badge badge-sm bg-gradient-success">{{ $item->Sdescription }}</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-secondary text-xs font-weight-bold">{{ $item->Ldescription }}</span>
                                            </td>
                                            <td class="align-middle text-center">
